...
def load_model():
    ...
    model = torch.hub.load('ultralytics/yolov5', 'custom', path='/app/CervicalRegion_streamlit/model/ModelYOLOv5m-R1-CervicalRegion-last.pt', force_reload=True) # or yolov5m, yolov5l, yolov5x, custom
